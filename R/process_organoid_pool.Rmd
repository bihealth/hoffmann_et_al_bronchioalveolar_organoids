...
```{r get_data}
samples <- c(paste(c('AO15','AO16','AO22'),'pool','16h','control',sep='_'),
             paste(c('AO13','AO18'),'pool','batch1','control',sep='_'),
             paste(c('AO13','AO15'),'pool','batch2','control',sep='_'))
...
write.csv(markers,file.path('..','data','seurat','organoids_pool_markers.csv'),row.names=FALSE)
...
```{r save, cache=FALSE}
saveRDS(sobj,file='../data/seurat/organoids_pool.rds')
```
